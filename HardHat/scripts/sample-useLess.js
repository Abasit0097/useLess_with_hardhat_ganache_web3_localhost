...
async function main() {
  ...
  //let setPause = await useLessToken.pause(false);
  //console.log("setPaused = ", setPause);

  //let pause2 = await useLessToken.paused();
  //console.log("Paused after = ", pause2);

  //let mint = await useLessToken.mint(2);
